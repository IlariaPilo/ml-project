...
def quadratic_svm_plot():
    ...
    gaussF_pcaF_ptilde_0_1_c_0 = np.array([0.484248, 0.522502, 0.588509, 0.923042, 1.000000, 0.995350])
    gaussF_pcaF_ptilde_0_5_c_0 = np.array([0.164966, 0.160016, 0.190486, 0.578124, 0.829016, 0.898523])
    gaussF_pcaF_ptilde_0_9_c_0 = np.array([0.425093, 0.427976, 0.410541, 0.900257, 0.967413, 0.994949])
    gaussF_pca8_ptilde_0_1_c_0 = np.array([0.857486, 0.841434, 0.987099, 0.989049, 0.993399, 1.000000])
    gaussF_pca8_ptilde_0_5_c_0 = np.array([0.335850, 0.334133, 0.424342, 0.621179, 0.838984, 0.983665])
    gaussF_pca8_ptilde_0_9_c_0 = np.array([0.678635, 0.694386, 0.763293, 0.876204, 1.000000, 0.996633])
    gaussF_pcaF_ptilde_0_1_c_1 = np.array([0.269127, 0.211971, 0.260426, 0.570957, 1.000000, 0.998350])
    gaussF_pcaF_ptilde_0_5_c_1 = np.array([0.063573, 0.056706, 0.073574, 0.216955, 0.774811, 0.838167])
    gaussF_pcaF_ptilde_0_9_c_1 = np.array([0.180618, 0.153082, 0.176651, 0.513651, 0.998316, 0.998316])
    gaussF_pca8_ptilde_0_1_c_1 = np.array([0.273177, 0.214071, 0.232073, 0.735374, 0.973597, 0.991749])
    gaussF_pca8_ptilde_0_5_c_1 = np.array([0.056839, 0.053339, 0.060206, 0.520419, 0.552772, 0.946578])
    gaussF_pca8_ptilde_0_9_c_1 = np.array([0.161016, 0.153382, 0.140814, 0.981481, 0.966030, 0.998316])
